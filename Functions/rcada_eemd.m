function [t,allmode] = rcada_eemd(Y, NoiseLevel, NE, numImf, varargin)
...
% randType: default=2; 1: uniformly distributed random noise; 2: gaussian white noise
